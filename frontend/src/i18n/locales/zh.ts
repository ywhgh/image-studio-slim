export default {
  ...
  imageStudio: {
    ...
    header: {
      ...
      externalMode: '外部模式',
      sessionStats: '本次会话 ✓ {success} · ✗ {failure}',
    ...
    previewCanvas: {
      ...
      panHint: '滚轮上下滑动图片，按住不动可让图片浮起来自由拖动；右键缩小，Ctrl+滚轮缩放。',
      freeDragHint: '已浮起：可任意拖动到屏幕任何位置。按 Esc 还原到画布中央。',
      helpTitle: '预览操作',
      helpKeyClick: '点击',
      helpKeyHold: '长按',
      helpKeyWheel: '滚轮',
      helpClickDesc: '打开预览大图',
      helpHoldDesc: '让图浮起，自由拖到任意位置',
      helpWheelDesc: '上下滑动图片',
      helpZoomDesc: '缩放',
      helpArrowDesc: '上一张 / 下一张',
      helpEscDesc: '退出浮起 / 关闭预览',
      metaEmpty: '等待生成结果',
      statusTitle: '生成状态',
    ...
    toasts: {
      ...
      promptCopyEmpty: '当前没有可复制的提示词。',
      promptCopyUnsupported: '当前环境无法访问剪贴板。',
    ...
    sidebar: {
      ...
      historyTitle: '历史记录',
      historySubtitle: '恢复之前的提示词，或重新打开旧批次。',
      variantsTitle: '工作区',
