export default {
  ...
  admin: {
    ...
    settings: {
      ...
      imageStudio: {
        title: '图像工作室',
        description: '在侧边栏显示内置图像工作台，并提供一个可复用的精简嵌入页',
        enabled: '启用图像工作室',
        enabledHint: '此分支默认开启，普通用户和管理员都可以在个人导航中访问'
      },
      customMenu: {
        title: '自定义菜单页面',
  ...
  imageStudio: {
    title: '图片生成助手',
    description: '在可拖拽的本地工作区中生成、整理和预览图片，并持续查看 API Key 的额度、状态与生图次数。',
    embedDescription: '可用于 iframe 嵌入的独立图片生成助手页面',
    notEnabledTitle: '图片生成助手已关闭',
    notEnabledDesc: '管理员尚未启用图片生成工作区入口。',
    disabledCardTitle: '图片生成助手当前不可用',
    disabledCardText: '管理员已关闭图片生成工作区入口，因此此页面暂时无法访问。',
    workspaceEyebrow: '双语 · 响应式 · 本地工作区',
    workspaceTitle: '图片生成助手',
    workspaceSubtitle: '支持中英文切换、响应式布局、工作区拖拽排序与框选多图，并可直接查看当前 API Key 的生图额度和次数。',
    openBareEmbedPage: '打开独立页面',
    providerManagedSize: '由 Sub2API 内置图像尺寸控制',
    sections: {
      provider: '模型与通道',
      aspectRatio: '画幅比例',
      resolution: '分辨率',
    ...
    hints: {
      provider: '第三方 API Key 仅保存在当前内存中，不会写入浏览器持久化存储。',
      sub2apiReuse: '这里会直接调用当前站点接口，只需要填写可用的 API Key，无需登录。',
      currentSiteEndpoint: '可改成你的服务器域名或 chatgpt2api 地址；留空会自动使用当前站点默认路径。',
      currentSiteKeySub2api: '用于当前站点 Sub2API 兼容接口，可点击测试连接检查 /api/v1/health 是否可访问。',
      currentSiteKeyChatgpt2api: '填写 chatgpt2api 的 Auth Key，可点击测试连接检查 /v1/models 是否可访问。',
    ...
    promptCompatibility: {
      title: '风控兼容预览',
      description: '这是为当前提示词准备的上游兼容预览。你可以保持原提示词，也可以开启兼容模式，让生成前的改写更稳一点。',
      originalTitle: '原提示词',
    ...
    fields: {
      ...
      currentSiteProfile: '当前站点接口模式',
      currentSiteEndpoint: '当前站点地址',
    ...
    placeholders: {
      soraKey: '请输入当前站点可用的 API Key',
      currentSiteKeySub2api: '请输入 Sub2API 可用的 API Key',
      currentSiteKeyChatgpt2api: '请输入 chatgpt2api 的 Auth Key',
      baseUrl: 'https://api.example.com/v1',
      apiKey: 'sk-...',
      prompt: '例如：电影感赛博朋克城市夜景，潮湿街道倒影，商业级布光，细节锐利。'
    },
    buttons: {
      start: '开始生成',
      generating: '生成中...',
      ...
      downloadSelected: '下载已选图片',
      downloadPreview: '下载当前图片',
      expand: '展开',
      collapse: '收起',
      clear: '清空',
      restore: '恢复',
    ...
    testConnection: {
      ...
      busy: '测试中...',
      ok: '连接正常',
      okNoModels: '连接正常，未返回模型列表',
      fail: '连接失败',
      httpError: '上游返回 {status}'
    },
    popovers: {
      connectionTitle: '通道',
      connectionSubtitle: '配置上游 API 凭据，关闭后立即生效。',
      connectionMissing: '尚未配置',
      connectionReady: '已就绪',
      advancedTitle: '参数',
      advancedSubtitle: '分辨率、背景、批量、参考图。'
    },
    header: {
      kicker: 'AI 图像工作流',
      remainingLabel: '剩余额度',
      statusLabel: '当前状态',
      imageQuota: '生图额度',
      awaitingKey: '等待填写 Key',
      awaitingUsage: '等待查询额度',
      awaitingImageQuota: '等待查询',
      queryingImageQuota: '查询中',
      imageQuotaUnavailable: '不可查',
      imageQuotaUnlimited: '无限',
      imageQuotaUnknown: '未知',
      imageQuotaCount: '{count} 张',
      imageQuotaDetail: '可用账号 {available}/{total}',
      externalMode: '外部模式',
      sessionStats: '本次会话',
      sessionSuccess: '成功 {count}',
      sessionIssue: '异常 {count}',
      statusRunning: '生成中 {value}s',
      statusLastDuration: '上次用时 {value}s',
      statusError: '上次失败',
      statusReady: '待命中'
    },
    settings: {
      title: '生成设置',
      subtitle: '模型、风格与参数',
      modelHint: '填好通道密钥后会自动从上游探测模型',
      modelDetecting: '正在从上游探测模型...',
      modelDetected: '已探测到 {count} 个图像模型',
      modelRefresh: '重新从上游探测模型',
      styleTitle: '风格预设',
      viewAll: '全部风格',
      customRatio: '自定义',
      defaultLabel: '默认',
    ...
    promptPanel: {
      title: '提示词编辑器',
      subtitle: '先写清核心画面，再用风格和负面提示补充约束。',
      clear: '清空',
      optimize: '优化提示词',
      optimizing: '润色中...',
      randomIdea: '随机灵感',
      ...
      upstreamCompatibilityRewriting: '兼容中...',
      upstreamCompatibilityOn: '已开启：生成前使用提示词模型重写为更稳的上游兼容版本',
      upstreamCompatibilityOff: '已关闭：点击可预览兼容版提示词，普通生成不会自动弹窗',
      upstreamCompatibilityHint: '开启风控兼容后，会尽量保留画面并弱化容易触发断流的表达。',
      upstreamCompatibilityMissing: '风控兼容需要先配置提示词模型。',
      ...
      quickCountHint: '最多 5 张，按单张任务排队生成。'
    },
    promptWorkspace: {
      previewAlt: '提示词效果预览',
      style: '风格',
      ...
      waitingForTemplate: '等待选择',
      templateImagePlaceholder: '选择提示词模板后，这里显示模版效果图。',
      editShort: '编辑',
      chooseShort: '选择',
      editorTitle: '编辑提示词',
      editorSubtitle: '在这里专注调整当前提示词，确认后会同步回主编辑框。',
      editorHint: '建议保留主体、场景、光线和风格四类信息。',
      cancel: '取消',
      libraryTitle: '提示词库',
      librarySubtitle: '选择内置灵感，或上传 txt、md、json 文件导入自己的提示词。',
      searchPlaceholder: '搜索标题、描述或提示词',
      uploadPrompt: '上传提示词',
      uploadImage: '上传预览图',
      titleLabel: '标题：',
      categoryLabel: '分类：',
      descriptionLabel: '描述：',
      promptLabel: '提示词：',
      localTitlePlaceholder: '标题，例如：赛博雨夜',
      descriptionPlaceholder: '描述',
      localPromptPlaceholder: '粘贴或输入这张图对应的提示词',
      saveLocalPrompt: '保存到本地',
      localStorage: '本地存储',
      localSaved: '已保存到本地提示词库。',
      localDeleted: '已删除本地提示词。',
      localSaveFailed: '保存本地提示词失败。',
      localDeleteFailed: '删除本地提示词失败。',
      localPromptRequired: '请先填写提示词。',
      localStorageUnavailable: '当前浏览器不支持本地图片存储。',
      imageTypeInvalid: '请上传图片文件。',
      imageTooLarge: '图片太大，请上传 20MB 以内的图片。',
      imageTooMany: '最多只能上传 {max} 张预览图。',
      deletePrompt: '删除提示词',
      noPromptResults: '没有找到匹配的提示词',
      emptyPrompt: '先输入提示词，这里会同步展示预览文案。',
      sourceResult: '当前效果图',
      sourceReference: '参考图预览',
      sourcePreset: '风格预览',
      builtinPrompt: '内置提示词',
      builtinSource: '内置灵感',
      uploadedPrompt: '上传提示词',
      uploadedSource: '本地导入',
    ...
    previewCanvas: {
      ...
      magnifier: '放大镜',
      exitMagnifier: '关闭放大镜',
      magnifierHint: '在图片上移动鼠标即可查看局部细节。',
      zoomHint: '左键放大，右键缩小，滚轮微调，拖动可自由查看画面细节。',
      panHint: '滚轮放大/缩小，拖拽移动已放大的图片。',
      immersiveHint: '沉浸预览中：滚轮缩放，拖拽移动，Esc 退出全屏。',
      helpTitle: '预览操作',
      helpKeyClick: '点击',
      helpKeyHold: '长按',
      helpKeyWheel: '滚轮',
      helpClickDesc: '打开预览大图',
      helpHoldDesc: '进入全屏沉浸预览',
      helpWheelDesc: '放大 / 缩小',
      helpZoomDesc: '放大 / 缩小',
      helpArrowDesc: '上一张 / 下一张',
      helpEscDesc: '关闭预览',
      metaEmpty: '等待生成结果',
      statusTitle: '生成状态',
      summaryEmpty: '还没有选中的历史批次。',
      summaryReady: '已生成 {count} 张 · {time}',
      summaryGenerating: '任务正在进行中，完成后会自动进入工作区。',
      summaryHint: '选择图片后可查看细节、对比变体或继续迭代。',
      regenerate: '重新生成',
      rerunWithCurrent: '按当前设置重跑',
      variantGenerate: '基于当前图生成变体'
    },
    statusBoard: {
      eyebrow: '状态面板',
      title: '生图状态总览',
      subtitle: '当前站点 API Key 的额度、状态、生图请求次数和产出张数会持续显示在这里。',
      externalSubtitle: '外部上游模式无法直接读取平台额度，因此这里会继续显示当前工作区状态。',
      externalUsageHint: '当前使用的是外部上游模式，无法通过本站接口读取第三方额度或生图次数。切回“当前站点 API Key”后可查看。',
      providerLabel: '当前通道',
      tileLabel: '工作区图片',
      selectionLabel: '已选图片',
      generationLabel: '生成状态',
      ready: '待命',
      generating: '生成中 {progress}%'
    },
    usage: {
      title: 'API Key 用量',
      subtitle: '通过 `/v1/usage` 查看剩余额度、状态、生图请求次数、生图张数，以及最近的尺寸分布。',
      enterKey: '请输入当前站点 API Key 后再查询。',
      readyHint: '当前还没有拉取用量数据，点击刷新按钮即可加载。',
      queryFailed: '查询 API Key 用量失败。',
      imageQuotaQueryFailed: '查询 chatgpt2api 生图额度失败。',
      none: '暂无',
      remaining: '剩余额度',
      balance: '余额',
      todayImageRequests: '今日生图请求',
      totalImageRequests: '累计生图请求',
      todayImages: '今日生图张数',
      totalImages: '累计生图张数',
      statusLabel: 'API 状态',
      todayRequests: '今日总请求',
    ...
    emptyStates: {
      previewTitle: '生成结果会显示在这里',
      previewText: '填写提示词并选择通道后，开始生成即可。',
      history: '还没有本地生成记录。首次成功生成后会自动出现在这里。'
    },
    loading: {
    ...
    workbench: {
      title: '工作区',
      subtitle: '每一张生成图都会变成一个格子，可拖拽排序、框选多选，并支持放大预览。',
      toolbarTitle: '批量操作',
      toolbarSubtitle: '支持框选、多选、批量下载与批量删除，工作区顺序会保存在浏览器本地。',
      dragTip: '拖拽排序 / 空白处框选 / Ctrl 或 Command 多选',
      tileCount: '共 {count} 张',
      selectedCount: '已选 {count} 张',
      dragHandle: '拖拽排序',
      toggleSelection: '选择图片',
      emptyTitle: '工作区还没有图片',
      emptyText: '从左侧发起生成后，每一张完成的图片都会自动进入这里，方便继续筛选和管理。',
      generatingText: '生成中的任务会先在这里预留位置，完成后自动加入工作区。',
      closePreview: '关闭预览',
      previousPreview: '上一张',
      nextPreview: '下一张',
      ...
      deleteConfirm: '确定删除已选中的 {count} 张图片吗？',
      clearConfirm: '确定清空工作区中的 {count} 张图片吗？',
      undo: '撤销',
      undoDeleted: '已删除 {count} 张图片',
      undoCleared: '已清空 {count} 张图片',
      elapsedSeconds: '已耗时 {value}s',
      durationSeconds: '用时 {value}s',
      generatingHeading: '生成中...',
      batchGeneratingHeading: '正在生成 {done}/{total}',
      batchProgressLabel: '{done}/{total}',
      batchProgressDetail: '{running} 张生成中，{queued} 张排队中',
      batchProgressDetailWithFailed: '{running} 张生成中，{queued} 张排队中，{failed} 张失败',
      currentImageProgress: '当前图片',
      currentBatchImageProgress: '第 {current}/{total} 张',
    ...
    providerModes: {
      ...
      externalRelay: {
        label: '外部中转',
        description: '推荐默认模式，适合不确定 CORS 的上游。'
      },
      externalBrowser: {
        label: '浏览器直连',
    ...
    currentSiteProfiles: {
      sub2apiCompatible: {
        label: 'Sub2API / Sora 兼容',
        description: '使用当前站点 /api/v1/chat/completions，适合原来的 Sora 兼容后端。'
      },
      chatgpt2api: {
        label: 'chatgpt2api / OpenAI 图片接口',
        description: '使用当前站点 /v1/images/generations 或 /images/edits，适合 chatgpt2api 这类 OpenAI 兼容图片后端。'
      }
    },
    qualities: {
      high: '高',
    ...
    toasts: {
      loadKeysFailed: '加载 Sora API Key 失败。',
      ...
      selectedDeleted: '已从本地工作区删除 {count} 张图片。',
      workspaceCleared: '本地工作区已清空。',
      noActiveImage: '当前没有可下载的图片。',
      downloadFailed: '下载失败。',
      copyImageUnsupported: '当前环境不支持直接复制图片。',
      imageCopied: '图片已复制到剪贴板。',
      copyImageFailed: '复制图片失败。',
      deleteUndone: '已恢复 {count} 张图片',
      optimizeApplied: '已用模型润色提示词。',
      inspirationApplied: '已用模型生成新灵感。',
      helperFailed: '调用提示词模型失败。',
      helperEmpty: '模型未返回有效结果。',
      helperConfigure: '已用本地默认润色，配置模型可获得更好效果。',
      modelProbeFailed: '模型探测失败，已保留当前模型，可手动输入模型名继续生成。',
      modelProbeNoModels: '未从上游返回图像模型，已保留当前模型，可手动输入模型名。'
    },
    preview: {
      title: '工作区预览',
      subtitle: '点击工作区中的任意格子即可放大查看。',
      alt: '生成图片预览'
    },
    history: {
      title: '本地历史',
      subtitle: '仅保存在浏览器缓存中，清理浏览器数据后会一并移除。',
      itemCount: '{count} 张图片',
      generatedAt: '生成',
      duration: '耗时',
      stylePreset: '风格',
    ...
    sidebar: {
      ...
      helperBaseUrlPlaceholder: '例如 https://api.openai.com/v1',
      ...
      helperConfirm: '保存',
      evolutionTitle: '变体演进',
      evolutionSubtitle: '最新在顶，从下往上读。点击行可放大查看。',
      evolutionCurrent: '本次',
      evolutionPrev: '上次',
      evolutionNoCurrent: '本次还未生成',
      evolutionNoPrev: '还没有上一张',
      historyTitle: '历史记录',
      historySubtitle: '保留最近生成的提示词与参数，方便快速恢复和继续编辑。',
      clearHistoryConfirm: '确定要清空全部历史记录吗？此操作只会删除本地缓存中的图片。',
      variantsTitle: '工作区',
      variantsSubtitle: '可在这里多选当前批次图片并执行批量操作。',
      selectAll: '全选',
      noVariants: '当前批次还没有图片。',
      downloadTitle: '下载与管理',
      downloadSubtitle: '集中处理当前图片与多选图片。',
      downloadCurrent: '下载当前图',
      downloadSelected: '下载已选图',
      downloadSelectedHint: '下载已选的 {count} 张图片',
      copyImage: '复制图片',
      copyImageHint: '把当前图片复制到剪贴板',
      deleteSelected: '删除已选图',
      deleteSelectedHint: '从本地历史中删除 {count} 张图片',
      downloadEmpty: '选择图片后即可使用这些操作',
      footerNote: '下载、复制和删除都只作用于本地工作区缓存。',
      deleteHistoryConfirm: '确认删除这条历史记录及其全部图片吗？'
    },
    appearance: {
      button: '工作室主题',
      title: '界面主题',
      subtitle: '统一调节圆角、主色、材质、动效和白夜模式。',
      reset: '恢复默认',
      themeMode: '白昼 / 夜间',
      radius: '全局圆角',
      accent: '主题颜色',
    ...
    upload: {
      uploadLabel: '上传参考图',
      removeLabel: '移除参考图',
      hint: '支持 PNG、JPG、WEBP，可用于图生图或带参考图的生成。'
    }
  },
