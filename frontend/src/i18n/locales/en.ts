export default {
  ...
  imageStudio: {
    ...
    header: {
      ...
      sessionStats: 'This session ✓ {success} · ✗ {failure}',
    ...
    previewCanvas: {
      ...
      panHint: 'Scroll to slide vertically. Hold the image to detach it for free drag. Right click zooms out, Ctrl+scroll zooms.',
      freeDragHint: 'Floating: drag the image anywhere on screen. Press Esc to recenter.',
      helpTitle: 'Preview shortcuts',
      helpKeyClick: 'Click',
      helpKeyHold: 'Hold',
      helpKeyWheel: 'Wheel',
      helpClickDesc: 'Open the lightbox',
      helpHoldDesc: 'Float the image and drag freely',
      helpWheelDesc: 'Pan the image vertically',
      helpZoomDesc: 'Zoom',
      helpArrowDesc: 'Previous / next',
      helpEscDesc: 'Exit float / close lightbox',
    ...
    toasts: {
      ...
      promptCopyEmpty: 'No prompt available to copy.',
      promptCopyUnsupported: 'Clipboard is not available in this environment.',
    ...
    sidebar: {
      ...
      historyTitle: 'History',
      historySubtitle: 'Restore a previous prompt or reopen an earlier generation batch.',
