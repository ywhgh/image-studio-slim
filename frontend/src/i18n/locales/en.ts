export default {
  ...
  admin: {
    ...
    settings: {
      ...
      imageStudio: {
        title: 'Image Studio',
        description: 'Show the integrated image generation workspace in the sidebar and expose a bare page for iframe embedding',
        enabled: 'Enable Image Studio',
        enabledHint: 'Enabled by default in this fork so both users and admin personal navigation can access it'
      },
      customMenu: {
  ...
  imageStudio: {
    ...
    description: 'Generate, organize, and review images in a draggable local workspace with API-key usage visibility.',
    embedDescription: 'Standalone image generation assistant page for iframe embedding',
    notEnabledTitle: 'Image Generation Assistant is disabled',
    notEnabledDesc: 'The administrator has not enabled the image generation workspace yet.',
    disabledCardTitle: 'Image Generation Assistant is currently unavailable',
    disabledCardText: 'The administrator has turned off the image generation workspace, so this page is temporarily unavailable.',
    workspaceEyebrow: 'Bilingual · Responsive · Local Workspace',
    workspaceTitle: 'Image Generation Assistant',
    workspaceSubtitle: 'Switch between Chinese and English, generate in a compact responsive layout, and manage every result inside a draggable workbench with API usage always in view.',
    openBareEmbedPage: 'Open standalone page',
    providerManagedSize: 'Managed by the built-in Sub2API image size',
    sections: {
      provider: 'Model and Provider',
    ...
    hints: {
      provider: 'Third-party API keys stay only in memory and are never written to browser storage.',
      sub2apiReuse: 'This calls the current site API directly. Paste a working API key and you can generate without signing in.',
      currentSiteEndpoint: 'You can change this to your server domain or chatgpt2api address. Leave it blank to use the current-site default path.',
      currentSiteKeySub2api: 'Used for the current-site Sub2API-compatible endpoint. Test connection checks whether /api/v1/health is reachable.',
      currentSiteKeyChatgpt2api: 'Enter the chatgpt2api auth key. Test connection checks whether /v1/models is reachable.',
    ...
    promptCompatibility: {
      ...
      description: 'This is the upstream-compatible preview for the current prompt. Keep the original prompt, or enable compatibility mode for a steadier rewrite before generation.',
      ...
      cancel: 'Cancel',
      useOriginal: 'Keep Original Prompt',
      useCompatible: 'Enable Compatibility'
    },
    generationErrors: {
    ...
    fields: {
      ...
      currentSiteProfile: 'Current Site API Mode',
      currentSiteEndpoint: 'Current Site Endpoint',
      currentSiteKeySub2api: 'Sub2API API Key',
    ...
    placeholders: {
      soraKey: 'Enter a current-site API key',
      currentSiteKeySub2api: 'Enter a Sub2API API key',
      currentSiteKeyChatgpt2api: 'Enter the chatgpt2api auth key',
      baseUrl: 'https://api.example.com/v1',
      apiKey: 'sk-...',
      prompt: 'Example: cinematic cyberpunk city at night, reflective wet streets, commercial lighting, crisp detail.'
    },
    buttons: {
      start: 'Start Generation',
      generating: 'Generating...',
      cancel: 'Cancel ({value}s)',
      cancelShort: 'Cancel',
      checkUsage: 'Refresh Usage',
      checkingUsage: 'Refreshing...',
      downloadCurrent: 'Download Current Image',
      downloadSelected: 'Download Selected',
      downloadPreview: 'Download Current',
      expand: 'Expand',
      collapse: 'Collapse',
      clear: 'Clear',
      restore: 'Restore',
    ...
    testConnection: {
      ...
      busy: 'Testing...',
      ok: 'Connection OK',
      okNoModels: 'Connection OK, no model list returned',
      fail: 'Connection failed',
      httpError: 'Upstream returned {status}'
    },
    popovers: {
      connectionTitle: 'Provider',
      connectionSubtitle: 'Set upstream API credentials. Closes apply instantly.',
      connectionMissing: 'Not set',
      connectionReady: 'Ready',
      advancedTitle: 'Output',
      advancedSubtitle: 'Resolution, background, batch, reference image.'
    },
    header: {
      ...
      awaitingKey: 'Waiting for API key',
      awaitingUsage: 'Usage not loaded',
      awaitingImageQuota: 'Not loaded',
      queryingImageQuota: 'Loading',
      imageQuotaUnavailable: 'Unavailable',
      imageQuotaUnlimited: 'Unlimited',
      imageQuotaUnknown: 'Unknown',
      imageQuotaCount: '{count} left',
      imageQuotaDetail: 'Available accounts {available}/{total}',
      externalMode: 'External mode',
      sessionStats: 'This session',
      sessionSuccess: 'Done {count}',
      sessionIssue: 'Issues {count}',
      statusRunning: 'Generating {value}s',
      statusLastDuration: 'Last {value}s',
      statusError: 'Last failed',
      statusReady: 'Ready'
    },
    settings: {
      title: 'Generation Settings',
      subtitle: 'Model, style, and controls',
      modelHint: 'Fill in the connection then I will probe upstream for models',
      modelDetecting: 'Probing upstream for models...',
      modelDetected: 'Detected {count} image model(s)',
      modelRefresh: 'Re-probe upstream models',
    ...
    promptPanel: {
      ...
      subtitle: 'Describe the scene clearly, then refine it with style and negative guidance.',
      clear: 'Clear',
      ...
      upstreamCompatibilityOn: 'On: rewrite the prompt with the prompt-helper model before generation',
      upstreamCompatibilityOff: 'Off: click to preview a compatible prompt; normal generation will not open this dialog automatically',
      upstreamCompatibilityHint: 'When enabled, the visual scene is preserved while wording likely to trigger upstream safety filters is softened.',
      upstreamCompatibilityMissing: 'Safety compatibility needs a configured prompt-helper model.',
      ...
      quickCountHint: 'Generate up to 5 images as separate queued tasks.'
    },
    promptWorkspace: {
      previewAlt: 'Prompt effect preview',
      style: 'Style',
      ratio: 'Ratio',
      model: 'Model',
      count: 'Images',
      ...
      waitingForTemplate: 'Waiting',
      templateImagePlaceholder: 'Choose a prompt template to show its preview image here.',
      editShort: 'Edit',
      chooseShort: 'Choose',
      editorTitle: 'Edit Prompt',
      editorSubtitle: 'Refine the current prompt here. Applying it syncs back to the main editor.',
      editorHint: 'Keep the subject, scene, lighting, and style clear.',
      cancel: 'Cancel',
      libraryTitle: 'Prompt Library',
      librarySubtitle: 'Pick a built-in idea or upload your own txt, md, or json prompt file.',
      searchPlaceholder: 'Search titles, descriptions, or prompt text',
      uploadPrompt: 'Upload Prompt',
      uploadImage: 'Upload preview',
      titleLabel: 'Title:',
      categoryLabel: 'Category:',
      descriptionLabel: 'Description:',
      promptLabel: 'Prompt:',
      localTitlePlaceholder: 'Title, e.g. Cyberpunk rain',
      descriptionPlaceholder: 'Description',
      localPromptPlaceholder: 'Paste or type the prompt for this image',
      saveLocalPrompt: 'Save Locally',
      localStorage: 'Local storage',
      localSaved: 'Saved to the local prompt library.',
      localDeleted: 'Deleted from the local prompt library.',
      localSaveFailed: 'Failed to save the local prompt.',
      localDeleteFailed: 'Failed to delete the local prompt.',
      localPromptRequired: 'Enter a prompt first.',
      localStorageUnavailable: 'This browser does not support local image storage.',
      imageTypeInvalid: 'Please upload an image file.',
      imageTooLarge: 'Image is too large. Please upload an image under 20MB.',
      imageTooMany: 'You can upload up to {max} preview images.',
      deletePrompt: 'Delete prompt',
      noPromptResults: 'No matching prompts found',
      emptyPrompt: 'Start typing a prompt and the preview copy will appear here.',
      sourceResult: 'Current image',
      sourceReference: 'Reference preview',
      sourcePreset: 'Style preview',
      builtinPrompt: 'Built-in Prompt',
      builtinSource: 'Built-in',
      uploadedPrompt: 'Uploaded Prompt',
      uploadedSource: 'Local import',
    ...
    previewCanvas: {
      ...
      openOverview: 'Preview Full Image',
      actualSize: 'Actual Size',
      magnifier: 'Magnifier',
      exitMagnifier: 'Exit Magnifier',
      magnifierHint: 'Move over the image to inspect fine details.',
      zoomHint: 'Left click zooms in, right click zooms out, the wheel fine-tunes, and drag pans the image.',
      panHint: 'Scroll to zoom in or out. Drag to pan a zoomed image.',
      immersiveHint: 'Immersive preview: wheel to zoom, drag to pan, Esc exits fullscreen.',
      helpTitle: 'Preview shortcuts',
      helpKeyClick: 'Click',
      helpKeyHold: 'Hold',
      helpKeyWheel: 'Wheel',
      helpClickDesc: 'Open the lightbox',
      helpHoldDesc: 'Enter immersive fullscreen preview',
      helpWheelDesc: 'Zoom in / out',
      helpZoomDesc: 'Zoom in / out',
      helpArrowDesc: 'Previous / next',
      helpEscDesc: 'Close lightbox',
      metaEmpty: 'Waiting for image output',
      statusTitle: 'Generation Status',
      summaryEmpty: 'No history batch selected yet.',
      summaryReady: '{count} image(s) ready · {time}',
      summaryGenerating: 'Generation is in progress. Finished images will appear in the workspace automatically.',
      summaryHint: 'Select an image to inspect details, compare variants, or continue iterating.',
      regenerate: 'Regenerate',
      rerunWithCurrent: 'Run with Current Settings',
      variantGenerate: 'Create Variant'
    },
    statusBoard: {
      eyebrow: 'Status Board',
      title: 'Generation Status Overview',
      subtitle: 'Current-site API quota, status, image-request counts, and output counts stay visible here while you work.',
      externalSubtitle: 'External upstream mode cannot expose platform quota through this site, so this panel keeps showing your workspace state instead.',
      externalUsageHint: 'The current mode uses an external upstream. Switch back to "Current Site API Key" to query platform quota and image-generation counts.',
      providerLabel: 'Current Channel',
      tileLabel: 'Workspace Images',
      selectionLabel: 'Selected Images',
      generationLabel: 'Generation State',
      ready: 'Ready',
      generating: 'Generating {progress}%'
    },
    usage: {
      title: 'API Key Usage',
      subtitle: 'View remaining quota, status, image-request counts, image counts, and recent size distribution through `/v1/usage`.',
      enterKey: 'Enter a current-site API key to query usage.',
      readyHint: 'Usage data has not been queried yet. Use the refresh button to load it.',
      queryFailed: 'Failed to query API key usage.',
      imageQuotaQueryFailed: 'Failed to query chatgpt2api image quota.',
      none: 'None',
      remaining: 'Remaining Quota',
      balance: 'Balance',
      todayImageRequests: 'Image Requests Today',
      totalImageRequests: 'Total Image Requests',
      ...
      plan: 'Plan',
      expiresAt: 'Expires At',
      todaySizeMix: 'Today Size Mix',
      totalSizeMix: 'Total Size Mix',
      status: {
        active: 'Active',
        disabled: 'Disabled',
    ...
    emptyStates: {
      previewTitle: 'Results will appear here',
      previewText: 'Fill in the prompt, choose your provider, and start generating.',
      history: 'No local generations yet. Your first successful run will appear here.'
    },
    loading: {
    ...
    workbench: {
      title: 'Workbench',
      subtitle: 'Each generated image becomes a tile. Reorder, multi-select, and preview at full size from here.',
      toolbarTitle: 'Batch Actions',
      toolbarSubtitle: 'Drag to reorder, marquee-select on empty space, and handle selected images in one step.',
      dragTip: 'Drag to sort / marquee-select on empty space / Ctrl or Command for multi-select',
      tileCount: '{count} image(s)',
      selectedCount: '{count} selected',
      dragHandle: 'Drag to reorder',
      toggleSelection: 'Select image',
      emptyTitle: 'Your workbench is still empty',
      emptyText: 'Start a generation from the left panel and every finished image will be added here automatically.',
      generatingText: 'The running generation is reserving space here and will join the workbench as soon as it completes.',
      ...
      deleteConfirm: 'Delete the selected {count} image(s) from the local workbench?',
      clearConfirm: 'Clear all {count} image(s) from the local workbench?',
      undo: 'Undo',
      undoDeleted: 'Deleted {count} image(s)',
      undoCleared: 'Cleared {count} image(s)',
      elapsedSeconds: 'Elapsed {value}s',
      durationSeconds: 'Took {value}s',
      generatingHeading: 'Generating...',
      batchGeneratingHeading: 'Generating {done}/{total}',
      ...
      currentBatchImageProgress: 'Image {current}/{total}',
    ...
    providerModes: {
      ...
      externalRelay: {
        ...
        description: 'Recommended when CORS support is unknown.'
      },
      externalBrowser: {
    ...
    currentSiteProfiles: {
      sub2apiCompatible: {
        label: 'Sub2API / Sora Compatible',
        description: 'Uses the current-site /api/v1/chat/completions endpoint for the original Sora-compatible backend.'
      },
      chatgpt2api: {
        label: 'chatgpt2api / OpenAI Images',
        description: 'Uses current-site /v1/images/generations or /images/edits for chatgpt2api-style OpenAI-compatible image backends.'
      }
    },
    qualities: {
      high: 'High',
    ...
    toasts: {
      loadKeysFailed: 'Failed to load Sora API keys.',
      ...
      selectedDeleted: 'Deleted {count} selected image(s) from the local workbench.',
      workspaceCleared: 'The local workbench has been cleared.',
      noActiveImage: 'There is no active image to download.',
      downloadFailed: 'Download failed.',
      copyImageUnsupported: 'This environment does not support direct image copying.',
      imageCopied: 'Image copied to clipboard.',
      copyImageFailed: 'Failed to copy image.',
      deleteUndone: 'Restored {count} image(s)',
      optimizeApplied: 'Prompt polished by your model.',
      inspirationApplied: 'New idea generated by your model.',
      helperFailed: 'Prompt assistant request failed.',
      helperEmpty: 'Model returned an empty result.',
      helperConfigure: 'Used local fallback. Configure a model for better output.',
      modelProbeFailed: 'Model probing failed. Kept the current model; you can type a model name manually.',
      modelProbeNoModels: 'No image models were returned. Kept the current model; you can type a model name manually.'
    },
    preview: {
      title: 'Workbench Preview',
      subtitle: 'Click any tile in the workbench to open it at full size.',
      alt: 'Generated image preview'
    },
    history: {
      title: 'Local History',
      subtitle: 'Stored only in the browser cache. Clearing browser data removes these items.',
    ...
    sidebar: {
      ...
      helperBaseUrl: 'Base URL',
      helperBaseUrlPlaceholder: 'e.g. https://api.openai.com/v1',
      ...
      evolutionSubtitle: 'Newest on top, read bottom-up. Click a row to enlarge.',
      evolutionCurrent: 'This',
      evolutionPrev: 'Last',
      evolutionNoCurrent: 'Nothing here yet',
      evolutionNoPrev: 'No previous batch',
      historyTitle: 'History',
      historySubtitle: 'Recent prompts and settings stay here for quick reuse and editing.',
      clearHistoryConfirm: 'Clear all history records? This only removes images stored in the local cache.',
      variantsTitle: 'Workspace',
      variantsSubtitle: 'Select one or more tiles from the active batch for quick actions.',
      selectAll: 'Select All',
      noVariants: 'No images in the current batch yet.',
      downloadTitle: 'Downloads',
      downloadSubtitle: 'Handle the current image or multi-selected tiles from one place.',
      downloadCurrent: 'Download Current',
      downloadSelected: 'Download Selected',
      downloadSelectedHint: 'Download {count} selected image(s)',
      copyImage: 'Copy Image',
      copyImageHint: 'Copy the current image to your clipboard',
      deleteSelected: 'Delete Selected',
      deleteSelectedHint: 'Delete {count} selected image(s) from local history',
      downloadEmpty: 'Select an image to enable these actions',
      footerNote: 'Download, copy, and delete actions only affect your local workspace cache.',
      deleteHistoryConfirm: 'Delete this history entry and all of its images?'
    },
    appearance: {
      button: 'Studio appearance',
      title: 'Studio Theme',
      subtitle: 'Tune radius, color, material, motion, and day-night mood.',
      reset: 'Reset',
      themeMode: 'Day / Night',
      radius: 'Corner Radius',
      accent: 'Accent Color',
      texture: 'Component Feel',
      motion: 'Motion',
      motionOn: 'Motion enabled',
      motionOff: 'Motion reduced',
      themeModes: {
        day: 'Day',
        night: 'Night'
      },
      ...
      textureDescriptions: {
        soft: 'Balanced depth with a gentle card feel',
        glass: 'Sharper highlights with a translucent layer',
        solid: 'Tighter surfaces with lower visual noise'
      }
    },
    upload: {
      uploadLabel: 'Upload Reference',
      removeLabel: 'Remove Reference',
      hint: 'PNG, JPG, and WEBP are supported for image-to-image and reference-based generation.'
    }
  },
